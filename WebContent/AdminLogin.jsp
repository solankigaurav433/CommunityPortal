...
<ul class="breadcrumb">
 ...
 <div class="wrapper fadeInDown zero-raduis">
  	 <div id="formContent">
  	   <s:a cssClass="underlineHover" href='login.jsp' style="margin-right:70%;">USER LOGIN ?</s:a>
  	    <div class="fadeIn first">
  	      <h2 class="my-5">Sign In</h2>
  	    </div>
 <s:form action="Admin" method="post" name="logi" class="log" theme="bootstrap" onSubmit="return myFunction()">
		<s:textfield cssClass="fadeIn second zero-raduis" name="email" placeholder="Username"></s:textfield>

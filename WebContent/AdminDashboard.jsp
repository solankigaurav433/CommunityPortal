...
<a href="ReportAction"><button class="btn btn-outline-info">Report</button>
						</a> 
			...
			<s:form action="Search" method="post" theme="bootstrap" name="searchForm" onSubmit="return myFunction()">
					...
					<div class="input-group">
						<h4
							...
							<s:textfield placeholder="Search by First Name"
							 style="width:200%;" 
...
<img class="mr-3 mt-3 rounded-circle" style="width:60px;" src="image/avtar.png" alt="Card image">
  <div class="media-body">
   ...
   <p>Country - India<br>Lives in Mumbai<br>Company - Lithan</p>
   </div>
   </div>
   </div>
...
<script>
	function myFunction() {
		...
		{
			alert("Search field cannot be empty"+" "+"please search by First Name ");
